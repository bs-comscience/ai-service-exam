...
st.set_page_config(
    ...
    page_icon="uk_flag.png"
)

st.title("영어 문장 만들기")
# --- 입력 ---
word = st.text_input("문장 생성에 사용할 영단어", placeholder="vacation", value="vacation")
...
count = st.text_input("문장 생성 개수", placeholder="3", value="3")
...
if st.button("문장 만들기"):
    ...
    prompt = f"영단어 {word}를 사용, 어휘수준 {level}에 맞는, {grammer}를 포함한, 문장 {count}개 생성"
