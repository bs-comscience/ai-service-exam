...
<div style="display: flex; justify-content: center; margin-top: 10px; margin-bottom: 10px;">
  <table style="border-collapse: collapse; width: 95%;">
    <tr>
      <td style="
          border: 2px solid #ADD8E6;  /* 연한 테두리 */
          padding: 15px;
          background-color: #ffffff;
          font-size: 14px;
          text-align: left;        /* 텍스트 가운데 */
      ">
       ✔  파이썬 기반으로 만든 웹 앱입니다. <br>
       ✔  <b>남일 사랑 Test</b>는 코드가 필요합니다. <b>컴퓨터실습실(별관2층)</b>로 GO GO!
      </td>
    </tr>
  </table>
</div>
...
rows = [
    ...
    ("1723 정홍재", "남일 사랑 Test <b> (선착순 상품 증정~!!!) </b>", "https://donghoje-jwojsmeatpc9gjazpx2pup.streamlit.app/"),
]
